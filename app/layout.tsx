...
export const metadata: Metadata = {
  title: 'Muhammad Asraf — Programmer & Technology Enthusiast',
  description:
  ...
  keywords: ['Muhammad Asraf', 'Full-Stack Developer', 'React', 'Next.js', 'Node.js', 'NestJS', 'JavaScript', 'Indonesia'],
  authors: [{ name: 'Muhammad Asraf', url: 'https://github.com/asrafmi' }],
  openGraph: {
    title: 'Muhammad Asraf — Programmer & Technology Enthusiast',
